    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Натуральная <br />
              <span style={{ color: '#c9a227' }}>косметика</span> <br />
              для Казахстана
            </h1>
            <p className="text-white/70 text-lg mb-8 leading-relaxed">
              Бренд «Сокровища Крыма» — натуральные кремы, масла, скрабы и ароматы. 
              Без химии, без переплат. Доставка по всему Казахстану.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <a href="https://wa.me/77000000000"
            ...
            <div className="flex gap-8 mt-12 pt-8 border-t border-white/10">
              <div>
                ...
                <p className="text-white/60 text-sm">товара</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-white">6</p>
                <p className="text-white/60 text-sm">категорий</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-white">🚚</p>
                <p className="text-white/60 text-sm">По всему Казахстану</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
          {CATEGORIES.filter(c => c.id !== 'all').map(cat => (
            <Link key={cat.id} href={`/catalog?cat=${cat.id}`}
              className="flex flex-col items-center gap-2 p-4 bg-white rounded-2xl border border-gray-100 hover:border-green-300 hover:shadow-md transition-all group card-hover">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-12">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/catalog" className="text-sm font-medium hover:underline" style={{ color: '#1a6b3c' }}>
            Все товары →
          </Link>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            { icon: '🌿', title: 'Натуральный состав', desc: 'Без парабенов, SLS и искусственных красителей. Только природные компоненты.' },
      ...
      <section className="py-16" style={{ background: 'linear-gradient(135deg, #1a6b3c, #0a2d1c)' }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a href="https://wa.me/77000000000?text=Здравствуйте!%20Интересует%20оптовый%20заказ%20на%20косметику%20Сокровища%20Крыма"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105"
            style={{ background: '#c9a227', color: '#0f1c14' }}>
            📱 Написать в WhatsApp
          </a>
